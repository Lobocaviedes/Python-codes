...
# Crear tabla para la cuota de $1,600,000 (escenario a 10 años)
tabla_10_anos = crear_tabla_amortizacion(
    monto_inicial=105309052.05,  # Saldo después de 8 cuotas
    tasa_ea=0.10139,
    cuota_mensual=1600000,
    plazo_meses=113
)
...
print(tabla_10_anos.head(120).to_string())
